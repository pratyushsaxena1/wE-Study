...
<body>
    ...
    <header class = "header"> Add Study Resource </header>
    <hr>
	<form action="successemailsend.php" method="POST">
        <label for="email">Email:</label><br>
    	<input type="text" id="email" name="email" placeholder="Example: w3study.contact@gmail.com" required><br>
    	<label for="password">Password:</label><br>
    	<input type="password" id="password" name="password" placeholder="Example: password" required><br>
    	<label for="link">Link to Resource:</label><br>
    	<input type="text" id="link" name="link" placeholder="Example: https://quizlet.com/_bfy8ww?x=1jqt&i=40uot9" required><br>
    	<button type = "submit" name = "submit" id = "submitformbutton" onclick = "sendEmail()">Submit</button>
    </form>
